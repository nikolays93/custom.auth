...
<div class="register-form">
    ...
    <? else: ?>
        <form id="register-form<?= $rand ?>" class="form-register" method="post" action="<?= POST_FORM_ACTION_URI ?>"
                ...
                <div class="form-check">
                    <label class="form-check-label">
                        ...
                        <span class="form-check-label">Нажимая кнопку "Зарегистрироваться", я подтверждаю, что я ознакомился с <a
                                    ...
                                    href="javascript:;">политикой обработки персональных данных</a><br> и даю согласие на обработку мои персональных данных</span>
                    </label>
                </div>
            </div>
