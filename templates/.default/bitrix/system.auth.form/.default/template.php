    ...
    <form name="custom-auth-form" method="post" action="">
        ...
        <p class="custom-auth__other">
            <? if ($arResult["NEW_USER_REGISTRATION"] == "Y"): ?>
                ...
                <!-- data-src="/local/components/nikolays93/custom.auth/ajax.php?register=yes" -->
            <? endif ?>

            <a class="forgot" href="<?= PATH_TO_FORGOT_PASSWORD ?>" rel="nofollow">Забыли пароль?</a>
            <!-- data-src="/local/components/nikolays93/custom.auth/ajax.php?forgot_password=yes" -->
        </p>
    </form>
</div>
<?php if (!empty($_SERVER['HTTP_X_REQUESTED_WITH']) && 'xmlhttprequest' === strtolower($_SERVER['HTTP_X_REQUESTED_WITH'])): ?>
<script>
